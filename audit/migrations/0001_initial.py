# -*- coding: utf-8 -*-
# Generated by Django 1.10 on 2018-06-25 07:43
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('email', models.EmailField(max_length=255, null=True, unique=True, verbose_name=b'email address')),
                ('password', models.CharField(help_text=b"<a href='password/'>\xd0\xde\xb8\xc4\xc3\xdc\xc2\xeb</a>", max_length=128, verbose_name='password')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('auth_type', models.SmallIntegerField(choices=[(0, b'ssh=password'), (1, b'ssh-key')], default=0)),
